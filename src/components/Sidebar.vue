              ...
              <ul class="space-y-2 pb-2">
                ...
                <li>
                  <a href="#" target="_blank"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Score</span>
                    <span
                ...
                <li>
                  <a href="#" target="_blank"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Attendent</span>
                    <span
                      class="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">Pro</span>
                  </a>
                </li>
                <li>
                  <a href="#"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Student</span>
                  </a>
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="#"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Subject</span>
                  </a>
                </li>
                <li>
                  <a href="#"
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Class</span>
                  </a>
                </li>
                <li>
                  <a href="#"
